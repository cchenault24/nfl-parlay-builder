...
// The web client also has a MockParlayService behind a dev flag. Mobile is
// deliberately agent-only, so anything the UI shows came from a real run.
export class AgentParlayService {
