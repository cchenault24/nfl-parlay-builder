...
export const getStrategySpecificInstructions = (
  ...
  switch (varietyFactors.strategy) {
    ...
    case 'player_focused':
      ...
      instructions.push(
        '- Mix different stat categories (passing, rushing, receiving)'
      )
      break
    case 'contrarian':
    ...
    case 'situational':
      ...
      instructions.push(
        '- Look at motivation factors (playoff implications, etc.)'
      )
      break
  }
